...
```js
assert((() => { fightBeast(); return monsterNameText.innerText === 'fanged beast' && monsterHealthText.innerText === '60'})() && (() => { fightDragon(); return monsterNameText.innerText === 'dragon' && monsterHealthText.innerText === '300'})());
```
