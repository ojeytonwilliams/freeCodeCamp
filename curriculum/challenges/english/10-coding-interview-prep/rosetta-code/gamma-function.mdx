...
```js
assert(typeof gamma(.1)=='number')
```

`gamma(.1)` should return `9.513507698668736`.

```js
assert.equal(round(gamma(.1)), round(9.513507698668736))
```

`gamma(.2)` should return `4.590843711998803`.

```js
assert.equal(round(gamma(.2)), round(4.590843711998803))
```

`gamma(.3)` should return `2.9915689876875904`.

```js
assert.equal(round(gamma(.3)), round(2.9915689876875904))
```

`gamma(.4)` should return `2.218159543757687`.

```js
assert.equal(round(gamma(.4)), round(2.218159543757687))
```

`gamma(.5)` should return `1.7724538509055159`.

```js
assert.equal(round(gamma(.5)), round(1.7724538509055159))
```
